...
from cifarConfig import *

parser = argparse.ArgumentParser()
parser.add_argument('--path', type=str, default= "Exp/proxyless_cpu")
...
parser.add_argument(
    '--net', type=str, default='proxyless_cpu',
...
if __name__ == '__main__':
    ...
    if os.path.isfile(run_config_path):
        ...
        run_config = CifarRunConfig(**run_config)
        if args.valid_size:
    ...
    net = pyramid_base(net_config=net_config_url, n_classes=run_config.data_provider.n_classes,
    ...
    if args.resume:
        ...
        if args.train and run_manager.best_acc == 0:
            loss, acc1, acc5 = run_manager.validate(ist=False, return_top5=True)
