...
def build_candidate_ops(candidate_ops, in_channels, out_channels, stride, ops_order):
    ...
    name2ops.update({
        '1x1_Conv': lambda in_C, out_C, S: ConvLayer(in_C, out_C,kernel_size=1, stride=S),
        '3x3_Conv': lambda in_C, out_C, S: ConvLayer(in_C, out_C,kernel_size=3, stride=S),
        '5x5_Conv': lambda in_C, out_C, S: ConvLayer(in_C, out_C,kernel_size=5, stride=S),
        '7x7_Conv': lambda in_C, out_C, S: ConvLayer(in_C, out_C,kernel_size=7, stride=S),
        '3x3_DepthConv': lambda in_C, out_C, S: DepthConvLayer(in_C, out_C,kernel_size=3, stride=S),
        '5x5_DepthConv': lambda in_C, out_C, S: DepthConvLayer(in_C, out_C,kernel_size=5, stride=S),
        '7x7_DepthConv': lambda in_C, out_C, S: DepthConvLayer(in_C, out_C,kernel_size=7, stride=S),
        '2x2_avg_pool': lambda in_C, out_C, S: PoolingLayer(in_C, out_C, 'avg', stride=S),
        '2x2_max_pool': lambda in_C, out_C, S: PoolingLayer(in_C, out_C, 'max', stride=S),
        '3x3_avg_pool': lambda in_C, out_C, S: PoolingLayer(in_C, out_C, 'avg', stride=S,kernel_size=3),
        '3x3_max_pool': lambda in_C, out_C, S: PoolingLayer(in_C, out_C, 'max', stride=S,kernel_size=3)})
...
class MyModule(nn.Module):
    ...
    def get_flops(self, x):
        ...
        ###Sara Changed mode from none to full_v2
class MixedEdge(MyModule):
    MODE = 'two'   # full, two, None, full_v2
